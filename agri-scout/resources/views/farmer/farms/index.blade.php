...
@section('page_title', 'My Registered Farms')

@section('content')
<div class="glass-card p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h5 class="fw-bold mb-1 text-white"><i class="bi bi-tree-fill text-success me-2"></i> Registered Farm Property</h5>
            <p class="text-secondary small mb-0">Retrieved from Oracle Relational Database (FARMS table)</p>
        </div>
            ...
            <tbody>
                @forelse($farms as $f)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('farmer.farms.show', $f->FARM_ID) }}" class="btn btn-sm btn-success rounded-3 px-3">
                                <i class="bi bi-eye-fill me-1"></i> View Farm Details
                            </a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="text-center text-secondary py-4">No registered farms assigned to your profile.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
