            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-1"></i></div><strong>Farmers</strong>
                    </div>
                    <div class="number dashtext-1">{{ $farmersCount ?? ($farmers_count ?? 0) }}</div>
                  </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-1"></i></div><strong>Farms</strong>
                    </div>
                    <div class="number dashtext-2">{{ $farmsCount ?? ($farms_count ?? 0) }}</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-1"></i></div><strong>Field Officers</strong>
                    </div>
                    <div class="number dashtext-3">{{ $officersCount ?? ($officers_count ?? 0) }}</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    ...
                    <div class="number dashtext-4">{{ $customersCount ?? ($customers_count ?? 0) }}</div>
                  </div>
                  <div class="progress progress-template">
